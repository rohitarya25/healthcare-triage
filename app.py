...
st.title("🚑 AI Healthcare Triage System")

user_input = st.text_area("Enter your symptoms:")

if st.button("Analyze"):
    
    result = triage_system(user_input)   # ✅ defined here
    
    st.subheader("🔍 Results")
    
    # ✅ everything below must be inside this block
    st.write("**Extracted Symptoms:**", result['symptoms'])
    
    st.write("**Possible Disease(s):**")
    ...
    if result['urgency'] == "HIGH":
        ...
        st.warning("⚠️ MEDIUM - Consult a doctor soon")
        
    else:
        st.success("✅ LOW - Manage at home")
